...
import { Calculator, Info, Download, TrendingUp } from 'lucide-react';
      ...
      <section className="py-4 px-4 bg-white border-b">
        <div className="max-w-6xl mx-auto">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <a href="/finance/loan-calculators" className="hover:text-blue-600">Loan & Credit Calculators</a>
            <span className="mx-2">›</span>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700">
                Our EMI Calculator helps you determine the exact monthly installment amount 
